...
/**
 * Runs the KO-9 higher-price visual-emphasis evaluation synchronously against the live document.
 */
...
export const KO9Rule: RuleDefinition = {
  id: RULE_ID,
