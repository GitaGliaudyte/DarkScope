...
import { ApplicabilitySignal, computeScore, getConfidence, getProbability } from './scoring';
...
function detectPrivacySettingsReachability(context: AnalysisContext): RuleResult {
  try {
